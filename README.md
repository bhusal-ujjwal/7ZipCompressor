**Using C/C++ programming language and Qt UI toolkit, create a GUI frontend for a command-line-based 7-zip archiver/compressor. 
The application's user should be able to select files that will be archived and specify the output archive's path. 
